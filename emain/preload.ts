...
contextBridge.exposeInMainWorld("api", {
    ...
    getChangelog: (force) => ipcRenderer.invoke("get-changelog", force),
    ...
    onTabVisibilityChange: (callback) =>
        ipcRenderer.on("tab-visibility-change", (_event, visible) => callback(visible)),
